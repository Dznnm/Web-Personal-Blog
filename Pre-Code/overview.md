Project Description: You are required to build a personal blog where you can write and publish articles. The blog will have two sections: a guest section and an admin section.

# Guest Section —
A list of pages that can be accessed by anyone:
